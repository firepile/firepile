...
object VecAdd {
  ...
  def run = {
    ...
    val idata1 = BBArray.tabulate[Float](n)(i => random.nextFloat).directCopy
    val idata2 = BBArray.tabulate[Float](n)(i => random.nextFloat).directCopy
  ...
  def VecAdd(idata1: BBArray[Float], idata2: BBArray[Float])(implicit dev: Device): BBArray[Float] = {
    ...
    val odata = new BBArray[Float](idata1.length).directCopy
